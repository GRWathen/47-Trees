...
class BinaryTree {
  ...
  nextLarger(lowerBound) {
    ...
    let largerNumber = Number.MAX_SAFE_INTEGER;
    let largerNode = null;
    ...
    while (toVisitQueue.length) {
      ...
      if ((current.val > lowerBound) && (current.val < largerNumber)) {
        largerNumber = current.val;
        largerNode = current;
      }
    ...
    return ((largerNode === null) ? null : largerNode.val);
  }
